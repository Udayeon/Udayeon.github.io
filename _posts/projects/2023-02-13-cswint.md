...
title: 
description: |
  CSwin-Tiny Transformer for Classification - Inference with ImageNet1K(mini version) dataset
hide_image: true
tags:
  - projects
published: true
...
# 6. Evaluation
```
python -m torch.distributed.launch --nproc_per_node 1 --master_port 12345 main.py --eval --cfg configs/swin/swin_tiny_patch4_window7_224.yaml --resume checkpoints/CswinTransformer_tiny.pth --data-path imagenet
```

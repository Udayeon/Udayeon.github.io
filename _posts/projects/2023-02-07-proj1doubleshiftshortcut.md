...
class SwinTransformerBlock_WMSA(nn.Module):
...
class SwinTransformerBlock_SWMSA(nn.Module):
...
class SwinTransformerBlock_SWMSA2(nn.Module):
    r""" Swin Transformer Block.
...
class BasicLayer1(nn.Module):
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlock_WMSA(dim=dim, input_resolution=input_resolution,
            ...
            SwinTransformerBlock_SWMSA(dim=dim, input_resolution=input_resolution,
                                 num_heads=num_heads, window_size=window_size,
                                 ...
                                 norm_layer=norm_layer,
                                 fused_window_process=fused_window_process),
            SwinTransformerBlock_SWMSA2(dim=dim, input_resolution=input_resolution,
                                 num_heads=num_heads, window_size=window_size,
                                 shift_size= window_size // 2,
                                 mlp_ratio=mlp_ratio,
                                 qkv_bias=qkv_bias, qk_scale=qk_scale,
...
class SwinTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 embed_dim=96, depths=[3, 3, 9, 3], num_heads=[3, 6, 12, 24],
        ...
        layer1 = BasicLayer1(dim=int(embed_dim * 2 ** 0),
        ...
        layer2 = BasicLayer2(dim=int(embed_dim * 2 ** 1),
        ...
        layer3 = BasicLayer3(dim=int(embed_dim * 2 ** 2),
        ...
        layer4 = BasicLayer4(dim=int(embed_dim * 2 ** 3),
...
# 5. Evaluation
```
python -m torch.distributed.launch --nproc_per_node 1 --master_port 12345 main.py --eval --cfg configs/swin/swin_tiny_patch4_window7_224.yaml --resume checkpoints/swinshorcutdouble.pth --data-path imagenet
```
![image](https://user-images.githubusercontent.com/69246778/219562051-5d485014-8f08-4c65-be07-f68c15d9b366.png)

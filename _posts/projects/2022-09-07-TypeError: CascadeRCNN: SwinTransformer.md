...
## Edit /mmdetection/mmdetection/configs/swin/cascade_mask_rcnn_swin_base_patch4_window7_mstrain_480-800_giou_4conv1f_adamw_3x_coco.py 
```py
...
```
## 2. /mmdetection/mmdetection/mmdet/models/backbones/swin.py
```py
# Copyright (c) OpenMMLab. All rights reserved.
import warnings
...
class SwinTransformer(BaseModule):
    ...
    def forward(self, x):
        ...
        return outs
```
## 3. /mmdetection/mmdetection/mmdet/models/detectors/cascade_rcnn.py
```py
# Copyright (c) OpenMMLab. All rights reserved.

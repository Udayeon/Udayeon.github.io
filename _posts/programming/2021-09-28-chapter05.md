...
plt.show()
```
![스크린샷, 2021-09-28 16-06-19](https://user-images.githubusercontent.com/69246778/135039583-26d27c21-5aa8-4bec-81be-c9c1e7c86519.png)


# 5.9. SSD, ResNet 모델을 사용해 얼굴 검출
* * *
```py
import cv2
import numpy as np

...
자율주행을 강화시키기 위해 중요한 기술 중 하나인 경로 계획은 **차량의 움직임이 nonlinear, non-holonomic**하고, **주변 차량 및 인프라와의 충돌을 피하면서 
원하는 성능을 유지**해야 한다는 점에서 어려운 의사결정 및 제어 문제임. 또한 원하는 속도로 주행하거나 운전자를 보호하는 등의 조작도 필요해짐.   
